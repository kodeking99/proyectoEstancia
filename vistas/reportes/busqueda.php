...
<div class="content-wrapper">
        <div class="page-title">
          ...
          <div class="form-group">
                  ...
                  <input type="text" id="busqueda" class="form-control" placeholder="Ingresé el nombre/id del usuario">
                  <input type="button" value="Buscar" class="form_btn" onclick="busquedaUsuarios();">
          </div>
          </form>

          <div><a class="btn btn-primary btn-flat" href="?c=usuario&a=FormCrear"><i class="fa fa-lg fa-plus"></i></a>
        </div>
        </div>
        <div class="row">
          <div class="col-md-12">
                ...
                <?php foreach($p as $r):?>
                    <tr>
                      ...
                      <td>
                          ...
                          <a class="btn btn-danger btn-flat" href="?c=producto&a=Borrar&id=<?=$r->ID?>" onclick="return confirm('¿Desea eliminar este registro?');"><i class="fa fa-trash"></i></a>
