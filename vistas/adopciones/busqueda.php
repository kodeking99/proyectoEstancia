...
<div class="content-wrapper">
        <div class="page-title">
          ...
          <div class="form-group">
                  ...
                  <input type="text" id="busqueda" class="form-control" placeholder="Ingresé la adopcion">
                  <input type="button" value="Buscar" class="form_btn" onclick="busquedaAdopciones();">
          </div>
          </form>

          <div><a class="btn btn-primary btn-flat" href="?c=Adopciones&a=FormCrear"><i class="fa fa-lg fa-plus"></i></a>
        </div>
        </div>
        <div class="row">
          <div class="col-md-12">
