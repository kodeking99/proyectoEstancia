<div class="content-wrapper">
        <div class="page-title">
          ...
          <div class="form-group">
                  ...
                  <input type="text" id="busqueda" class="form-control" placeholder="Ingrese el nombre del seguimiento">
                  <input type="button" value="Buscar" class="form_btn" onclick="busquedaSeguimientos();">
          </div>
          </form>
          
          <div><a class="btn btn-primary btn-flat" href="?c=seguimientos&a=FormCrear"><i class="fa fa-lg fa-plus"></i>agregar</a>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12">
