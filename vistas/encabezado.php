      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Usuarios</span><i class="fa fa-angle-right"></i></a>
            ...
            <li class="treeview"><a href="?c=mascotas"><i class="fa fa-edit"></i><span>Mascotas</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
            ...
            <li class="treeview"><a href="?c=contratos"><i class="fa fa-th-list"></i><span>Contratos</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
            ...
            <li class="treeview"><a href="?c=adopciones"><i class="fa fa-file-text"></i><span>Adopciones</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
            ...
            <li class="treeview"><a href="?c=avisos"><i class="fa fa-file-text"></i><span>Avisos</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
                <li><a href="blank-page.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                <li><a href="page-login.html"><i class="fa fa-circle-o"></i> Login Page</a></li>
                <li><a href="page-lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen Page</a></li>
            ...
            <li class="treeview"><a href="?c=seguimientos"><i class="fa fa-file-text"></i><span>Seguimientos</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
                <li><a href="blank-page.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                <li><a href="page-login.html"><i class="fa fa-circle-o"></i> Login Page</a></li>
                <li><a href="page-lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen Page</a></li>
            ...
            <li class="treeview"><a href="?c=historias"><i class="fa fa-file-text"></i><span>Historias de exito</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
                <li><a href="blank-page.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                <li><a href="page-login.html"><i class="fa fa-circle-o"></i> Login Page</a></li>
                <li><a href="page-lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen Page</a></li>
            ...
            <li class="treeview"><a href="?c=visitas"><i class="fa fa-file-text"></i><span>Visitas</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
                <li><a href="blank-page.html"><i class="fa fa-circle-o"></i> Blank Page</a></li>
                <li><a href="page-login.html"><i class="fa fa-circle-o"></i> Login Page</a></li>
                <li><a href="page-lockscreen.html"><i class="fa fa-circle-o"></i> Lockscreen Page</a></li>
            ...
            <li class="treeview"><a href="?c=reportes"><i class="fa fa-pie-chart"></i><span>Reportes</span><i class="fa fa-angle-right"></i></a></li>

            <li class="treeview"><a href="?c=respaldos"><i class="fa fa-share"></i><span>Respaldo BD</span><i class="fa fa-angle-right"></i></a>
              <!--ul class="treeview-menu">
